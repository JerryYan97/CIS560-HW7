...
public:
    ...
    QPushButton *pushButtonLoadScene;
    QMenuBar *menuBar;
    QMenu *menuFile;
    QMenu *menuHelp;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonAddVertex->setGeometry(QRect(650, 420, 93, 28));
        ...
        pushButtonTriangulate->setGeometry(QRect(760, 420, 93, 28));
        pushButtonSmooth = new QPushButton(centralWidget);
        pushButtonSmooth->setObjectName(QStringLiteral("pushButtonSmooth"));
        pushButtonSmooth->setGeometry(QRect(870, 420, 93, 28));
        pushButtonExtrude = new QPushButton(centralWidget);
        pushButtonExtrude->setObjectName(QStringLiteral("pushButtonExtrude"));
        pushButtonExtrude->setGeometry(QRect(970, 420, 93, 28));
        pushButtonLoadScene = new QPushButton(centralWidget);
        pushButtonLoadScene->setObjectName(QStringLiteral("pushButtonLoadScene"));
        pushButtonLoadScene->setGeometry(QRect(970, 340, 93, 28));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButtonLoadScene->setText(QApplication::translate("MainWindow", "Load Scene", Q_NULLPTR));
